...
Workflows:
  ...
  - [CFD Mesh Generator](Docs/CfdMeshGenerator.md): Fill a clipped vessel surface with tetrahedra for a computational fluid dynamics solver, using TetGen or fTetWild, with capping, surface remeshing and an optional prismatic boundary layer.
...
See [Developer notes](Docs/Developers.md) for running a build and for running the automated tests.
