...
The annotation display controls can highlight angle labels above a threshold in red while the other labels remain yellow. Reset annotation colors restores all angle labels to yellow.
