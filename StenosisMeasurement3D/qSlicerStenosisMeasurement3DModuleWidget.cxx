...
void qSlicerStenosisMeasurement3DModuleWidget::onApply()
{
  ...
  if (!this->logic->Process(shapeNodeReal, segmentationNodeReal, currentSegmentID, fiducialNodeReal,
  ...
  this->createModels(shapeNodeReal, segmentationNodeReal, currentSegmentID, fiducialNodeReal,
                    wallOpen, lumenOpen);
}
...
//-----------------------------------------------------------------------------
void qSlicerStenosisMeasurement3DModuleWidget::createModels(vtkMRMLMarkupsShapeNode * wallShapeNode,
                                                            ...
                                                            vtkPolyData * outputWallOpenPolyData, vtkPolyData * outputLumenOpenPolyData)
{
  ...
  this->logic->CreateLesion(wallShapeNode, lumenSegmentationNode, segmentID, boundaryFiducialNode,
                          outputWallOpenPolyData, outputLumenOpenPolyData, lesion);
